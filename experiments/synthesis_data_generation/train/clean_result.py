...
map_fake_context_by_line_order(
    full_context_path= os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/train/results/train_parse_data/train_grouped_full_context.json"),
    fake_context_txt_path= os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/train/results/train_synthesis_data/train_fake_context.json"),
    output_path=os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/train/results/train_cleaned/train_cleaned.json"),
)
