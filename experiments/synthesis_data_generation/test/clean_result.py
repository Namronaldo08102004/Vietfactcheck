...
map_fake_context_by_line_order(
    full_context_path= os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/test/results/test_parse_data/test_grouped_full_context.json"),
    fake_context_txt_path= os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/test/results/test_synthesis_data/test_fake_context.json"),
    output_path=os.path.join(PROJECT_ROOT, "experiments/synthesis_data_generation/test/results/test_cleaned/test_cleaned.json"),
)
