...
JSON_PATH = os.path.join(project_root, "data", "extraction", "train_synthesis.json")   # your dataset
...
output_dir = os.path.join(project_root, "experiments", "factual_verb", "train", "results")
